...
#! GOAL : To implement a utility function for text and token ID conversion
...
#! NOTE : The context_length in the GPT_CONFIG_124M dictionary is reduced to 256 tokens in order to reduce the compuational demands of training the model.

#? Initializing the GPT model we created earlier
model = GPTModel(GPT_CONFIG_124M)

#? Importing the function to generate text we created earlier
...
#? Utility function for token ID to text conversion
...
#? OUTPUT: 
#? Output text:
#?  Every effort moves you poetic farmer McGee Britt Estimates Arabacked Argent visitors scattering

#! NOTE : The model is still not producing coherent text because it still hasn't undergone training.